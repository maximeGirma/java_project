...
public class ItemJeuPanel extends JPanel {
	...
	public ItemJeuPanel(){
		...
		//CATEGOTY ARTWORK//
		categoGamLabel = new JLabel(new ImageIcon("src\\main\\java\\img\\artJeux.png"));
	...
	//	artistLabel = new JLabel("Artiste: ");
		...
		artistTypeCombo.addItem("Studio");
		artistTypeCombo.addItem("Editeur");
		artistTypeCombo.addItem("Distributeur");
		...
		artist2TypeCombo.addItem("Studio");
		artist2TypeCombo.addItem("Editeur");
		artist2TypeCombo.addItem("Distributeur");
